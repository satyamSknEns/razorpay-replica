...
const Profile = () => {
  ...
  const otherDetails = [
    ...
    {
      label: "Date of Birth",
      value: `${String(data.profile?.DOB)?.slice(0, 10)}`,
    },
    {
      label: "Highest Educational Qualification",
      value: `${data.profile?.highestEducationalQualification}`,
    },
